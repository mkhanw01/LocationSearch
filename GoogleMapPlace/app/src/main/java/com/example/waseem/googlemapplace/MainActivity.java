package com.example.waseem.googlemapplace ;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class GetPlaces extends AsyncTask<Void, Void, ArrayList<Place>> {
        ...
        {
            PlacesService service = new PlacesService("AIzaSyD1tsbGjrfup7Gy4FHKhAV5oXVO2UanRZY");
    ...
    private void initCompo() {
        ...
        mMap.addMarker(new MarkerOptions().position(latLng).icon(BitmapDescriptorFactory.fromResource(R.drawable.mark)));
